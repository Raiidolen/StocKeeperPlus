...
export interface UserDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
   ...
   * })
   * 
   * // Create many Users and only return the `mail`
   * const userWithMailOnly = await prisma.user.createManyAndReturn({
   *   select: { mail: true },
   *   data: [
   *     // ... provide data here
   *   ]
   ...
   * })
   * 
   * // Update zero or more Users and only return the `mail`
   * const userWithMailOnly = await prisma.user.updateManyAndReturn({
   *   select: { mail: true },
   *   where: {
   *     // ... provide filter here
   *   },
